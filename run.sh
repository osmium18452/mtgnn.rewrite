output_list="720 180 360 320 192 160 96 80 48 40 24 20"
...
for dataset in $dataset_list; do
    for output_len in $output_list; do
        ...
        save_file="save/best/$exec_date/$dataset/$output_len"
        ...
        save_file="save/worst/$exec_date/$dataset/$output_len"
